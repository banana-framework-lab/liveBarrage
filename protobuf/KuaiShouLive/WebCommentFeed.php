...
/**
 * Generated from protobuf message <code>KuaiShouLive.WebCommentFeed</code>
 */
class WebCommentFeed extends \Google\Protobuf\Internal\Message
{
    ...
    private $color = '';
    /**
     * Generated from protobuf field <code>.KuaiShouLive.WebCommentFeedShowType showType = 7;</code>
     */
    private $showType = 0;
    ...
    {
        GPBUtil::checkEnum($var, \KuaiShouLive\WebCommentFeedShowType::class);
        $this->showType = $var;
